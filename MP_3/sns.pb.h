...
template<> ::csce438::ServerConnect* Arena::CreateMaybeMessage<::csce438::ServerConnect>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace csce438 {
...
class ServerConnect final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:csce438.ServerConnect) */ {
 public:
  inline ServerConnect() : ServerConnect(nullptr) {}
  explicit constexpr ServerConnect(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ServerConnect(const ServerConnect& from);
  ServerConnect(ServerConnect&& from) noexcept
    : ServerConnect() {
    *this = ::std::move(from);
  }
  ...
  inline ServerConnect& operator=(ServerConnect&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  friend void swap(ServerConnect& a, ServerConnect& b) {
    a.Swap(&b);
  }
  inline void Swap(ServerConnect* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(ServerConnect* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline ServerConnect* New() const final {
    return new ServerConnect();
  }

  ServerConnect* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ServerConnect>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const ServerConnect& from) {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "csce438.ServerConnect";
  }
  protected:
  explicit ServerConnect(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  public:
  ...
  // @@protoc_insertion_point(class_scope:csce438.ServerConnect)
 private:
  class _Internal;
